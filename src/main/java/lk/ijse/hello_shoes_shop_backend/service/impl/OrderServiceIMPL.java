...
import lk.ijse.hello_shoes_shop_backend.repository.*;
...
public class OrderServiceIMPL implements OrderService {
    ...
    public void saveOrder(OrderDto orderDto) {
        ...
        OrderEntity orderEntity = conversionData.orderDtoConvertOrderEntity(orderDto);
    ...
    public String returnOrder(ReturnDto returnDto) {
        ...
        if (orderReturnLstDay.isBefore(todayDate)) {
            ...
            if (orderStatus.equals("ORDER CONFIRM")){
                ...
                returnRepo.save(conversionData.returnDtoConvertReturnEntity(returnDto));
    ...
    public List<OrderDto> getAllOrders() {
        ...
        return conversionData.ordeEntityListConvertOrdeDtoList(allOrder);
    }
    ...
    public OrderDto searchOrder(String searchOrderId) {
        ...
        if (orderEntity != null){
            return conversionData.orderEntityConvertOrderDto(orderEntity);
        }else{
            return null;
        }
    ...
    public List<OrderDto> branchWiseOrderDetailsGet(String branch) {
        ...
        for (OrderEntity all:allOrders) {
            ...
            if (branch.equals(employeeEntity.getAttachedBranch())){
                branchWiseOrders.add(conversionData.orderEntityConvertOrderDto(all));
            }
        }
    ...
    public List<OrderDto> employeeSaleAllOrdersGet(String empMail) {
        ...
        for (OrderEntity all :allOrders) {
            ...
            if (all.getEmployeeEntity().getEmployeeCode().equals(employeeCode)){
                employeeAllSale.add(conversionData.orderEntityConvertOrderDto(all));
            }
