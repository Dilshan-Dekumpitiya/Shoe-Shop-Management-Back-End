...
import lk.ijse.hello_shoes_shop_backend.repository.EmployeeRepo;
...
public class EmployeeServiceIMPL implements EmployeeService {
    ...
    public List<EmployeeDto> getAllEmployees() {
        ...
        return conversionData.employeeEntityListConvertEmployeeDtoList(allEmployees);

    }

    @Override
    public String saveEmployee(EmployeeDto employeeDto) {
        EmployeeEntity savedEmployee = employeeRepo.save(conversionData.employeeDtoConvertEmployeeEntity(employeeDto));
    ...
    public EmployeeDto searchEmployee(String searchEmployeeId) {
        ...
        if (employeeEntity !=null){
            return conversionData.employeeEntityConvertEmployeeDto(employeeEntity);
        }else {
