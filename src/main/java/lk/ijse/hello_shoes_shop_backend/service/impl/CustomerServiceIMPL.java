...
import lk.ijse.hello_shoes_shop_backend.repository.CustomerRepo;
...
public class CustomerServiceIMPL implements CustomerService {
    ...
    public List<CustomerDto> getAllCustomers() {
        List<CustomerDto> allCustomers = conversionData.customerEntityListConvertCustomerDtoList(customerRepo.findAll());
        return allCustomers;
    }

    @Override
    public void saveCustomer(CustomerDto customerDto) {
        customerRepo.save(conversionData.customerDtoConvertCustomerEntity(customerDto));
    }
    ...
    public CustomerDto searchCustomer(String searchCustomerId) {
        ...
        if (searchCustomer != null) {
            return conversionData.customerEntityConvertCustomerDto(searchCustomer);
        } else {
