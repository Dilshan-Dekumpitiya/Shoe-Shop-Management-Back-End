...
import lk.ijse.hello_shoes_shop_backend.repository.ItemRepo;
import lk.ijse.hello_shoes_shop_backend.repository.SizeRepo;
...
public class ItemServiceIMPL implements ItemService {
    ...
    public List<ItemDto> getAllItems() {
        ...
        return conversionData.itemEntityListConvertItemDtoList(all);
    }
    ...
    public void saveItem(String itemSupplySupplierId ,ItemDto itemDto,String size,String qty) {
        ...
        if (supplierEntity != null){
            ...
            ItemEntity itemEntity = conversionData.itemDtoConvertItemEntity(itemDto);
    ...
    public ItemDto searchItem(String searchItemId) {
        ...
        return conversionData.itemEntityConvertItemDto(itemEntity);
    }
